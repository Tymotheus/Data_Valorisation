...
|-------------------------------------|-----------|-----------|
| Linear Regression                   | 91,325.35 | 0.4656    |
| SVR (radial kernel + nu-regression) | 90,012.3  | 0.4809    |
| Regression Tree                     | 89,007.07 | 0.3410    |
| Random forest                       | 12,439.68 | 0.4924    |
...
However the last model, Random Forest that we created has around 12k RMSE, meaning average error of 6%. This is a much better performance, and in our opinion is a good predictor. Due to the relatively high accuracy, we see its real value for the users and a potential business value.
